...
const NotFound: React.FC = () => {
  return (
    <div className="pt-12 md:pt-16 pb-14 md:pb-26 px-4 md:px-0 container">
      <div className="border border-gray-5  mx-auto md:w-[90%] xl:w-full h-[595px] md:h-[654px] rounded-2xl flex flex-col justify-center items-center">
        ...
        <Link href="/" className="primary__btn w-39! text-xs md:text-base md:w-[393px]!">
          بازگشت به صفحه اصلی
        </Link>
