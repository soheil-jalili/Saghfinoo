import NavSearch from "@/components/module/Header/NavSearch";
import React from "react";

const HeroSection: React.FC = () => {
  return (
    <section className="hero__section relative flex items-center flex-col justify-center text-center px-4 md:px-0">
