  ...
  return (
    <section className="bg-gray-2 flex items-center justify-between gap-4 rounded-2xl mb-10 sm:mb-14 flex-wrap flex-col-reverse sm:flex-nowrap sm:flex-row sm:mx-4 md:mx-10.5  lg:mx-[65px] xl:mx-0">
      <div className="px-4 lg:px-8 inline-flex flex-col lg:max-w-145">
        ...
        <h2 className="text-gray-12 font-bold-shabnam! text-base sm:text-[40px] mb-2">
          رکود بازار مسکن
        </h2>

        <p className="text-gray-11 text-xs sm:text-2xl font-bold-shabnam! mb-4 sm:mb-6 leading-10">
          فروشندگان در انتظار خریداران و خریداران در انتظار شکست نرخ فروشندگان
        </p>
        <p className="line-clamp-2 text-gray-11 text-lg leading-8 mb-4 sm:mb-6">
          از منظر فعالان بازار مسکن، وضعیت فعلی بازار پاسخی است به جهشهای متوالی
          قیمت در سال‌های گذشته و به واسطه رشد نجومی قیمت‌ها در این بازار، فعلا
