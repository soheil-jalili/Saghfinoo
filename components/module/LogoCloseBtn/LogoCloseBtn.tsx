...
const LogoCloseBtn: React.FC = () => {
  return (
    <div className="px-4 flex items-center justify-center sm:hidden mt-14 mb-16">
      <Image
        src={"/assets/images/mobile-logo.png"}
        alt="Saghfino"
        width={80}
        height={39}
        className="w-20 h-[39px] object-contain flex-1"
      />
