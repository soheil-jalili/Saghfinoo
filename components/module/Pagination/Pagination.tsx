  ...
  return (
    <div className="flex items-center justify-center gap-3 mb-3 sm:mb-22 flex-row-reverse">
      <button className="cursor-pointer">
        ...
        >
          <path
            d="M15.0013 3.32998C14.8113 3.32998 14.6213 3.39998 14.4713 3.54998L7.95125 10.07C6.89125 11.13 6.89125 12.87 7.95125 13.93L14.4713 20.45C14.7613 20.74 15.2413 20.74 15.5312 20.45C15.8212 20.16 15.8212 19.68 15.5312 19.39L9.01125 12.87C8.53125 12.39 8.53125 11.61 9.01125 11.13L15.5313 4.60998C15.8212 4.31998 15.8212 3.83998 15.5313 3.54998C15.3813 3.40998 15.1912 3.32998 15.0013 3.32998Z"
            fill="#CBCBCB"
          />
        </svg>
      </button>
