...
const FooterLinkMain: React.FC<FooterLinkMainType> = ({
  className,
}: FooterLinkMainType) => {
  return (
    <div
      className={`flex items-start px-4 gap-2.5 min-[317px]:gap-5 min-[381px]:gap-8 ${className}`}
    >
      <div>
